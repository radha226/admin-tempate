                ...
                <div id="topbar-menu" class="navbar-collapse pln prn">
                    <ul class="nav navbar-nav logo-wrapper">
                        ...
                        <li class="pull-left"><a id="logo" href="index.html" class="pan"><img
                                src="{{asset('admin/assets/images/logo2.png')}}"/></a></li>
                    ...
                    <ul class="nav navbar-nav navbar-left topbar-nav">
                        <li class="dropdown"><a data-toggle="dropdown" href="#" class="dropdown-toggle"><i
                            ...
                            <ul class="dropdown-menu dropdown-task dropdown-topbar">
                                ...
                                <li class="last"><a href="http://www.next-themes.com/mtek/code/extra-user-list.html" class="text-right">See all alerts</a>
                                </li>
                            </ul>
                        </li>
                        <li class="dropdown"><a data-toggle="dropdown" href="#" class="dropdown-toggle"><i
                            ...
                            <ul class="dropdown-menu dropdown-alerts">
                                ...
                                <li>
                                    <div class="dropdown-slimscroll">
                                        <ul>
                                            <li class="unread"><a href="http://www.next-themes.com/mtek/code/extra-user-list.html" target="_blank"><span
                                            ...
                                            <li><a href="http://www.next-themes.com/mtek/code/extra-user-list.html" target="_blank"><span
                                    ...
                                    <div class="navbar-content">
                                        <div class="row">
                                            <div class="col-md-5 col-xs-5"><img
                                                    src="{{asset('admin/assets/images/face.jpg')}}" alt=""
                                    ...
                                    <div class="navbar-footer">
                                        <div class="navbar-footer-content">
                                            <div class="row">
                                                ...
                                                <div class="col-md-6 col-xs-6"><a href="#">
                                                    <button href="http://www.next-themes.com/mtek/code/page-lock-screen.html"
